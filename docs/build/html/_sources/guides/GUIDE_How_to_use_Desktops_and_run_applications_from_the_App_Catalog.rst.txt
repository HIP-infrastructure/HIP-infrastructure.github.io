...
The objective of this guide is to introduce Desktops, which operate as remote computers and are typically used to run the applications available in the App Catalog.
This guide comes with a video showing how to manage Desktops (create, display, pause/resume and switch between Desktops) and run one or several applications simultaneously.
It also explains essential rules regarding data access and persistence inside a Desktop environment. However, it does not cover the uses of the various applications
available in the App Catalog. In this perspective, the *HIP APPS* and *HIP TUTORIALS* sections accessible in the table of contents contain documentation, tutorials and
